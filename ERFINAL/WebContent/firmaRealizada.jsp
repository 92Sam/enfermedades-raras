...
<%@page import="er.domain.proyectos.Firma"%>
...
<div id="global">
	...
	<div id="navegacion">
	<ul><li><a href="noticias.html">Inicio</a></li><li><a href="#">Qué Hacemos</a></li><li><a href="#">Quiénes Somos</a></li><li><a href="#">Cómo puedes colaborar</a></li><li><a href="registro.html">Registro</a></li><li><a href="#">Noticias</a></li></ul>
</div>
	<div id="contenido">
		<div id="menu">
			<h1>Menú</h1>
			<ul><li><a href="enfermedades.html">Enfermedades</a></li><li><a href="proyecto.jsp">Proyectos</a></li><li><a href="#">Donaciones</a></li><li><a href="historia.jsp">Historias</a></li><li><a href="publicar.html">Publicar</a></li><li><a href="#">Firma</a></li><li><a href="ayuda.html">Ayuda</a></li><li><a href="salir.jsp">Salir</a></li></ul>
		</div>
		<p>
	Aquí podrá establecer su firma para confirmar que usted está de acuerdo con el propósito de esta asociación, es muy fácil y puede firmar quien quiera, sólo es necesario introducir su NIF válido y su nombre completo. Firmando ayudará a la asociación a seguir adelante con los proyectos en marcha.
		...
		boolean firmado = pu.compruebaFirma(dni);
		if(firmado && !vacio)
			res+="Ya has firmado, no puedes firmar otra vez";
		else if(!firmado && !vacio){
			Firma f = new Firma(nombre,apellidos,new Nif(dni));
			pu.introduceFirma(f);
			if(!vacio)
