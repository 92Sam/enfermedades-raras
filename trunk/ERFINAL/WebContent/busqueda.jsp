...
<div id="global">
	...
	<div id="contenido">
		<div id="menu">
			<h1>Menú</h1>
			<ul><li><a href="#">Enfermedades</a></li><li><a href="proyecto.jsp">Proyectos</a></li><li><a href="#">Donaciones</a></li><li><a href="historia.html">Historias</a></li><li><a href="publicar.html">Publicar</a></li><li><a href="firma.html">Firma</a></li><li><a href="ayuda.html">Ayuda</a></li><li><a href="salir.jsp">Salir</a></li></ul>
		</div>
	<p>
	...
	String res="";
	List enfermedades = EnfermedadFactoria.getInstance().getEnfermedades();
	boolean esta = false; 
	Iterator it = enfermedades.iterator();
	Enfermedad enf = null;
	while(it.hasNext()){
		Enfermedad aux = (Enfermedad)it.next();
		if(aux.getNombre().equals(nombremin)){
			esta=true;
			enf = aux;
			}
		}
...
<p><%=res %></p>
  ...
  <tr>
  	<% if(esta){ 
    out.write("<th scope='col'>"+nombremin+"</th>");                                               
  	out.write("<th scope='col'>"+enf.getDescripcion()+"</th>");
  	out.write("</tr>");
  	out.write("<tr>");
 	out.write("<td>Proyecto</td>");
  	...
  	out.write("<td>"+enf.getTratamiento().getNombre()+"</td>");
  	out.write("</tr>");
  	out.write("<tr>");
